...
- [x] Iteration 48: texture LFB color path selection behavior. Validated by
...
- [x] Iteration 51: texture color path reverse blend behavior. Validated by the
      video color0-local reverse blend test plus the workspace gates.
- [x] Iteration 52: texture color path non-reverse blend behavior. Validated by
...
- [x] Iteration 55: texture color path aother modulation behavior. Validated by
      the video texture color aother-modulation test plus the workspace gates.
- [x] Iteration 56: texture color path alocal modulation behavior. Validated by
      the video texture color alocal-modulation test plus the workspace gates.
- [x] Iteration 57: texture color path texture-alpha modulation behavior.
      Validated by the video texture color texture-alpha modulation test plus
      the workspace gates.
...
- [x] Iteration 63: texture alpha path other modulation behavior. Validated by
      the video texture alpha other-modulation test plus the workspace gates.
- [x] Iteration 64: texture alpha path texture-alpha modulation behavior.
      Validated by the video texture alpha texture-modulation test plus the
      workspace gates.
...
- [x] Iteration 69: texture alpha path color0 local-alpha select behavior.
      ...
      workspace gates.
- [x] Iteration 70: texture alpha path iter-Z local-alpha select behavior.
      Validated by the video texture alpha iter-Z local-select test plus the
      workspace gates.
- [ ] Next: texture alpha path float iter-Z local-alpha select behavior.

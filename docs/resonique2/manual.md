...
| FM synthesis | OPL3 (Yamaha YMF262) | `0x388` | — | — |
...
— the same shape of interrupt behavior a Sound Blaster DSP gives you, just
on its own port window so it can run concurrently with the SB16 and OPL3
sections rather than competing with them. Software that specifically

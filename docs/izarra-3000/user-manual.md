...
| Sound | ReSonique 2: Sound Blaster 16 compatible digital audio (PCM and Creative ADPCM), OPL3 FM, a P300 wavetable daughter card rendered by FluidSynth, and P330 output routed to Munt or one exact host MIDI destination. |
...
| I/O | PS/2 keyboard and mouse, serial, parallel, VGA, MIDI/game, line out, line in. |

...
def emit_layouts_inc(blocks, deadkeys, comps, out_path):
    lines = []
    A = lines.append
    A("; This file is part of IzarraVM and is licensed under GNU GPL version 3 only.")
    A("; SPDX-License-Identifier: GPL-3.0-only")
    A("")
...
def emit_meta_inc(out_path):
    lines = []
    lines.append("; This file is part of IzarraVM and is licensed under GNU GPL version 3 only.")

...
cmdspy flush
cmdspy restart
int ax=0x6000 -buf ds:si="abc�flkgsxkf\0" -buf es:di="%256s" -int 0x21 -d es:di:128 >spy_int.out
cmdspy stop
...
1123: IN:  abc�flkgsxkf [FAIL 0001]
1123: OUT:  C:\TOOL\INT.COM
1123: orig buffer:  abc�flkgsxkf
1123: IN:  C:\INTRSPY\SPY_INT.BAT [FAIL 0001]
1123: OUT:  C:\INTRSPY\ABC�FLKG
1123: orig buffer:  C:\INTRSPY\SPY_INT.BAT
...
42(B) 43(C) 99(�) 46(F) 4C(L) 4B(K) 47(G) 00(.) 3D(=) 30(0) 30(0) 30(0)

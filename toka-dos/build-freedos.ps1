...
# The TOKACD.SYS and IZCDEX.COM build steps retired with the IzarraCD
# consolidation (PRs #755/#756): the BIOS serves the CD-ROM, so the image
# carries no guest CD driver files. Their sources left the tree with slice
# CD-3; git history holds both.

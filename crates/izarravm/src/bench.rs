...
pub(super) fn perf_counters_json(
    ...
    let mut value = json!({
        ...
        "brk_cont_not_continuable": perf.brk_cont_not_continuable,
        "brk_cont_page_cross": perf.brk_cont_page_cross,
        ...
        "cr3_link_context_selects": perf.cr3_link_context_selects,
        "cr3_link_graph_retires": perf.cr3_link_graph_retires,
        ...
        "slot_reject_enabled": u64::from(fast_map_audit.slot_reject_enabled),
        "slot_reject_misaligned": fast_map_audit.slot_reject_misaligned,
        "slot_reject_page_cross": fast_map_audit.slot_reject_page_cross,
        "slot_reject_absent": fast_map_audit.slot_reject_absent,
        "slot_reject_epoch": fast_map_audit.slot_reject_epoch,
        "slot_reject_permission": fast_map_audit.slot_reject_permission,
        "slot_admit_misaligned": fast_map_audit.slot_admit_misaligned,
        ...
        "smc_heat_chunks_hot": perf.smc_heat_chunks_hot,
        ...
        "jit_direct_word_address_slots": perf.jit_direct_word_address_slots,
        "jit_direct_blocks_installed_sixteen_bit": perf.jit_direct_blocks_installed_sixteen_bit,
        "jit_direct_entries_sixteen_bit": perf.jit_direct_entries_sixteen_bit,
        "jit_direct_insns_sixteen_bit": perf.jit_direct_insns_sixteen_bit,
        ...
        "jit_direct_reject_data_segment_real": perf.jit_direct_reject_data_segment_real,
        "jit_direct_reject_data_segment_v86": perf.jit_direct_reject_data_segment_v86,
        "jit_direct_reject_data_segment_pm16": perf.jit_direct_reject_data_segment_pm16,
        "jit_direct_reject_data_segment_pm32": perf.jit_direct_reject_data_segment_pm32,
        ...
        "jit_direct_seg_guard_mismatch_exits": perf.jit_direct_seg_guard_mismatch_exits,
...
pub(super) fn print_perf_counter_row(
    ...
    println!(
        "perf  {:<10} {:<5} instr={:>13}  decode_hit={:>6.2}%  insns/run={:>9.1}  \
         ...
         cr3_ring[taken/skipped]={}/{} cr3_link[selects/retires]={}/{} translation[writes/a/d/marked]={}/{}/{}/{}  \
         data[rd d/s wr d/s]={}/{}/{}/{}  ptr[rd/wr]={}/{}  fastmap[hit/miss]={}/{}  \
         page[h/m]={}/{}  fetch_page[h/m slow_refill]={}/{}/{}  \
        ...
        perf.cr3_link_context_selects,
        perf.cr3_link_graph_retires,

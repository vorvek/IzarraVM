...
#[path = "cpu_jit_imm8_lane_test.rs"]
mod jit_imm8_lane;
...
#[path = "cpu_jit_v86_loop_rows_test.rs"]
mod jit_v86_loop_rows;
...
#[cfg(all(
    feature = "jit",
    feature = "direct-entry-attribution",
    target_arch = "x86_64",
    any(target_os = "windows", target_os = "linux")
))]
#[path = "cpu_entry_attribution_test.rs"]
mod entry_attribution;

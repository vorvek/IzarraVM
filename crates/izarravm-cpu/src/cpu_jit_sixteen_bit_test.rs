...
pub(crate) fn sixteen_bit_code_cpu(entry: u32) -> CpuGsw {
...
pub(crate) fn sixteen_bit_bus(memory: Vec<u8>) -> TestBus {
...
pub(crate) fn arm_native_sixteen_bit(cpu: &mut CpuGsw, bus: &mut TestBus, pages: &[u32]) {
...
pub(crate) fn warm_sixteen_bit(cpu: &mut CpuGsw, bus: &mut TestBus, starts: &[u32]) {

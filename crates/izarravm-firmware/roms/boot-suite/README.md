# IzarraVM Boot Test Suite

This directory contains the first BIOS-bootable compatibility target for IzarraVM.
...
- `izarravm-test.img` is the checked-in 1.44 MiB boot image artifact.
